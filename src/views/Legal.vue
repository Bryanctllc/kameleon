      ...
      <ul>
        <li>
          ...
          <p>
            ...
            utilisateurs du site https://lahaltemitoyenne.fr/ l'identité des
            différents intervenants dans le cadre de sa réalisation et de son
            suivi :
          </p>
          <p>
            <strong>Propriétaire</strong> : Kameleon – 75011<br />
            <strong>Créateur</strong> :
            Kameleon<br />
            <strong>Responsable publication</strong> : Kameleon –
            kameleon.equipe@gmail.com<br />
            Le responsable publication est une personne physique ou une personne
            morale.<br />
            <strong>Webmaster</strong> : Bryan Coutellec –
            bryan.coutellec@gmail.com<br />
        ...
        <li>
          ...
          <p>
            L’utilisation du site https://lahaltemitoyenne.fr/ implique
            ...
            utilisateurs du site https://lahaltemitoyenne.fr/ sont donc
          ...
          <p>
            ...
            toutefois décidée par Kameleon, qui s’efforcera alors de
            communiquer préalablement aux utilisateurs les dates et heures de
            l’intervention.
          </p>
          <p>
            Le site https://lahaltemitoyenne.fr/ est mis à jour régulièrement
            par Kameleon. De la même façon, les mentions légales peuvent
        ...
        <li>
          ...
          <p>
            Le site https://lahaltemitoyenne.fr/ a pour objet de fournir une
            information concernant l’ensemble des activités de la société.
          </p>
          <p>
            Kameleon s’efforce de fournir sur le site
            https://lahaltemitoyenne.fr/ des informations aussi précises que
          ...
          <p>
            ...
            https://lahaltemitoyenne.fr/ sont données à titre indicatif, et
            sont susceptibles d’évoluer. Par ailleurs, les renseignements
            figurant sur le site https://lahaltemitoyenne.fr/ ne sont pas
        ...
        <li>
          ...
          <p>
            Kameleon est propriétaire des droits de propriété
        ...
        <li>
          ...
          <p>
            Kameleon ne pourra être tenue responsable des dommages directs
            et indirects causés au matériel de l’utilisateur, lors de l’accès au
            site https://lahaltemitoyenne.fr/, et résultant soit de
          ...
          <p>
            Kameleon ne pourra également être tenue responsable des
            dommages indirects (tels par exemple qu’une perte de marché ou perte
            d’une chance) consécutifs à l’utilisation du site
            https://lahaltemitoyenne.fr/.
          </p>
          <p>
            Des espaces interactifs (possibilité de poser des questions dans
            l’espace contact) sont à la disposition des utilisateurs. Kameleon se réserve le droit de supprimer, sans mise en demeure
            ...
            relatives à la protection des données. Le cas échéant, Kameleon se réserve également la possibilité de mettre en cause la
        ...
        <li>
          ...
          <p>
            ...
            https://lahaltemitoyenne.fr/ n'est publiée à l'insu de
            l'utilisateur, échangée, transférée, cédée ou vendue sur un support
            quelconque à des tiers. Seule l'hypothèse du rachat de Kameleon et de ses droits permettrait la transmission des dites
            ...
            vis de l'utilisateur du site https://lahaltemitoyenne.fr/.
          </p>
          <p>
        ...
        <li>
          ...
          <p>
            Le site https://lahaltemitoyenne.fr/ contient un certain nombre de
            liens hypertextes vers d’autres sites, mis en place avec
            l’autorisation de Kameleon. Cependant, Kameleon n’a pas
          ...
          <p>
            La navigation sur le site https://lahaltemitoyenne.fr/ est
        ...
        <li>
          <h3 class="is-size-4 has-text-weight-semibold has-text-weight-semibold">
            9. Droit applicable et attribution de juridiction.
          </h3>
          <p>
            Tout litige en relation avec l’utilisation du site
            https://lahaltemitoyenne.fr/ est soumis au droit français. Il est
        ...
        <li>
          <h3
            class="is-size-4 has-text-weight-semibold has-text-weight-semibold"
          >
